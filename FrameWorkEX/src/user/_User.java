...
public interface _User extends Remote {
	...
	public abstract void executeFile(String name, byte[] file) throws RemoteException;
	...
	public byte[] downloadFile(String name, String fileName)throws RemoteException;
